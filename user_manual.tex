...
\begin{enumerate*}
	...
	\item [\textbf{op1}:] Second operator for the nodes in the given country.%Second SIM card for the node.
	\item [\textbf{op2}:] Third operator for the nodes in the given country.%Third SIM card for the node.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{TstatRRDGUI.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{TStatGraphitedashboard.png}
...
\begin{itemize}
\item[1.] Real time access on the node, logs for the last three generated are shared with MONROE experimenters on the "/monroe/tstat", it helps the MONROE users to use passive traces collected by Tstat during their experiment. the three logs can cover at most last three hours.
...
It is recommended to check the description of the logs on (\url{http://tstat.polito.it/measure.shtml#LOG}).  Figures~\ref{fig:TStattcp},\ref{fig:TStattcprtt},\ref{fig:TStathttp}  present the table describing of some interesting metrics in tcp and http logs.
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{tcpcomplete.png}
	\caption{Core TCP Set.}
	\label{fig:TStattcp}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{tcprtt.png}
	\caption{TCP End to End Set.}
	\label{fig:TStattcprtt}
\end{figure}


\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{httpcomplete.png}
	\caption{Core HTTP Set.}
	\label{fig:TStathttp}
\end{figure}
...
%An updated description of metadata topics and fields is kept in the following link:
%\url{}
